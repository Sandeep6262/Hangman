...
def ifValid(user_input):
    ...
    # user_input ki length 1 hai woh charecter hai
    return True
...
def hangman(secret_word):
    ...
    * Har round ke baar, user ko uska guess kiya hua partial word
    ...
    if level=="b":
        ...
        if level !="a":
            print "your choice is in void""\n""game is starting in easy leves"
    ...
    while (remaining_lives>0):
        ...
        if letter=="hint":
            print "your hint for this secret is " +get_hint(secret_word,letters_guessed)
        else:
        ...
        print "sorry you lose the game, the word wos -"+ secret_word
